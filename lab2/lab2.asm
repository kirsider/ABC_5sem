...
DATA_BEGIN      = $
    ...
    ENDM
    SIZE_IDT        =       ($ - IDT_BEGIN)
    MSG_HELLO           db "Нажмите 'p', чтобы перейти в защищенный режим",13,10,"$"
    MSG_HELLO_PM        db "Вы находитесть в защищенном режиме!",0
    MSG_HELLO_RM        db "Вы вернулись в реальный режим",13,10,"$"
    MSG_KEYBOARD        db "Нажмите 'ESC', чтобы вернуться в реальный режим",0
    MSG_EXC             db "Исключение: XX",0
    MSG_EXIT            db "Нажмите 'e', чтобы выйти",13,10,"$"
    MSG_ERROR           db "Неправильная ошибка$"
